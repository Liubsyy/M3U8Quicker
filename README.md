...
- 支持批量下载
- 支持视频预览图
- 兼容B站、抖音、CCTV等网站视频下载（浏览器扩展一键下载）
- 支持直播录制（HTTP-FLV和HLS格式）
...
| 系统 | 文件 | 说明 |
| :--- | :--- | :--- |
| <img src="./doc/img/icons/windows.svg" width="18" height="18" alt="Windows" /> **Windows** | **x64**：[安装包](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_windows_x64_setup.exe) \| [免安装包](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_windows_x64.zip)<br>**x86**：[安装包](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_windows_x86_setup.exe) \| [免安装包](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_windows_x86.zip) | 大多数电脑选 x64<br>32 位系统选 x86 |
| <img src="./doc/img/icons/macos.svg" width="18" height="18" alt="MacOS" /> **MacOS** | **Apple Silicon**：[安装包](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_macos_aarch64.dmg) \| [应用包压缩](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_macos_aarch64.app.tar.gz)<br>**Intel**：[安装包](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_macos_x64.dmg) \| [应用包压缩](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_macos_x64.app.tar.gz) | M芯片选 Apple Silicon<br>Intel 芯片选 Intel |
| <img src="./doc/img/icons/linux.svg" width="18" height="18" alt="Linux" /> **Linux** | **安装包**：[deb](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_linux_amd64.deb) \| [rpm](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_linux_x86_64.rpm)<br>**免安装**：[AppImage](https://github.com/Liubsyy/M3U8Quicker/releases/latest/download/M3U8.Quicker_1.2.1_linux_amd64.AppImage) | Ubuntu/Debian/Linux Mint选deb<br>Fedora/RHEL/CentOS Stream/openSUSE选rpm |
...
**浏览器扩展(可选)：** 在应用内打开“工具 -> 安装浏览器扩展”按引导安装即可。
